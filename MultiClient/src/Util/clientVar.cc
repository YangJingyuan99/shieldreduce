...
void ClientVar::InitUploadBuffer()
{
    ...
    tool::CreateUUID1(_curContainer.containerID, CONTAINER_ID_LENGTH);
    _curContainer.currentSize = 0;
    // con_times++;

    tool::CreateUUID1(_curDeltaContainer.containerID, CONTAINER_ID_LENGTH);
    ...
    // outRefContainerBuffer_ = (uint8_t*) malloc(MAX_CONTAINER_SIZE);
